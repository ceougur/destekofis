...
grant execute on function public.lisans_activate(text, jsonb, text) to anon, authenticated, service_role;
grant execute on function public.lisans_check(text, jsonb, text) to anon, authenticated, service_role;
grant execute on function public.lisans_operator(text, text, text, jsonb, text) to anon, authenticated, service_role;
